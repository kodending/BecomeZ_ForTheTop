...
public class PartSelectionController : MonoBehaviour
{
    ...
    public int headAccesoriesIndex = -1;
    public int leftShoulderIndex = -1;
    public int leftElbowIndex = -1;
    public int leftWeaponIndex = -1;
    public int leftShieldIndex = -1;
    public int rightShoulderIndex = -1;
    public int rightElbowIndex = -1;
    public int rightWeaponIndex = -1;
    public int chestIndex = -1;
    public int spineIndex = -1;
    public int lowerSpineIndex = -1;
    public int leftHipIndex = -1;
    public int leftKneeIndex = -1;
    public int rightHipIndex = -1;
    public int rightKneeIndex = -1;
    public int armPartsIndex = -1;
    public int legPartsIndex = -1;
    public int allBodyPartsIndex = -1;

    public List<string> headKeys = new List<string>();
    public List<string> hairKeys = new List<string>();
    public List<string> headAccesoriesKeys = new List<string>();
    public List<string> shoulderKeys = new List<string>();
    public List<string> elbowKeys = new List<string>();
    public List<string> weaponKeys = new List<string>();
    public List<string> shieldKeys = new List<string>();
    public List<string> chestKeys = new List<string>();
    public List<string> spineKeys = new List<string>();
    public List<string> lowerSpineKeys = new List<string>();
    public List<string> hipKeys = new List<string>();
    public List<string> kneeKeys = new List<string>();
    public List<string> armPartsKeys = new List<string>();
    public List<string> legPartsKeys = new List<string>();
